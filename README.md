...
[N8N Creator](https://n8n.io/creators/intuz/) · [AI Agent Development Company](https://www.intuz.com/company/) · [AI Workflow Automation](https://www.intuz.com/workflow-automation-services/) · [For Custom Workflow Automation](https://www.intuz.com/get-started/)

# Automate full-cycle invoicing from Airtable to QuickBooks and Stripe
...
- Client Name (Text)
- Client Email (Email)
- Status (Single-select with options: Draft, Approved for Invoicing, Invoiced)
...
When an Airtable record is updated and its Status is set to “Approved for Invoicing.” The workflow then syncs the customer in QuickBooks and Stripe, creates the invoice and payment link, and marks the record as “Invoiced.”
...
- [Automate real-time QuickBooks invoice alerts in Slack](https://github.com/Intuz-production/QuickBooks-Slack-Automation)
